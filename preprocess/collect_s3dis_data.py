...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/home/dell/ZHL/PointSS/data/S3DIS/Stanford3dDataset_v1.2_Aligned_Version',
    ...
    DST_PATH = os.path.join(ROOT_DIR, 'data/S3DIS')
    SAVE_PATH = os.path.join(DST_PATH, 'scenes', 'data')
    print('Data path:', DATA_PATH)
    print('Save path:', SAVE_PATH)
    if not os.path.exists(SAVE_PATH): os.makedirs(SAVE_PATH)

    CLASS_NAMES = [x.rstrip() for x in open(os.path.join(ROOT_DIR, 'data/S3DIS/meta', 's3dis_classnames.txt'))]
