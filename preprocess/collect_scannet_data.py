...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/home/dell/ZHL/PointSS/data/ScanNet/scans',
                        help='Directory to dataset')
    args = parser.parse_args()

    DATA_PATH = args.data_path
    DST_PATH = os.path.join(ROOT_DIR, 'data/ScanNet')
    SAVE_PATH = os.path.join(DST_PATH, 'scenes', 'data')
    if not os.path.exists(SAVE_PATH): os.makedirs(SAVE_PATH)

    meta_path = os.path.join(SAVE_PATH, 'meta')
